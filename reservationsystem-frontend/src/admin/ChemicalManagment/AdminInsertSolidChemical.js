...
function AdminInsertSolidChemical() {
  ...
  const validationSchema = Yup.object({
    ...
    availableQuantityinGrams: Yup.number()
      .required("Required")
  ...
  const onSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      const response = await FormService.postSolidChemical(values);
...
export default AdminInsertSolidChemical;
